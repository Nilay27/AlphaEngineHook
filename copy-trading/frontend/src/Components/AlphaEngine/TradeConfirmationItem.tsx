    ...
    <BaseCard>
      ...
      <DetailsSection>
        <DetailRow>
          ...
          <DetailValue>{confirmation.executionParams?.protocol || 'N/A'}</DetailValue>
        </DetailRow>
        <DetailRow>
          <DetailLabel>Action</DetailLabel>
          <DetailValue>{confirmation.executionParams?.action || 'N/A'}</DetailValue>
        </DetailRow>
      ...
      <ParamsSection>
        ...
        {isExpanded && (
          <JsonViewer>
            {JSON.stringify(confirmation.executionParams, null, 2)}
          </JsonViewer>
        )}
      </ParamsSection>
