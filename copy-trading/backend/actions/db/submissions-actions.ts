...
export async function createSubmissionAction(params: {
  ...
  try {
    ...
    const submissionId = params.onChainSubmissionId; 
    ...
    const insertResult = await db
      ...
      .values({
        ...
        onChainSubmissionId: params.onChainSubmissionId ?? '',
      })
      .returning();
...
export async function rejectSubmissionAction(params: {
  ...
  try {
    ...
    const [submission] = await db
      ...
      .where(eq(projectSubmissionsTable.submissionId, params.submissionId))
      .limit(1)
