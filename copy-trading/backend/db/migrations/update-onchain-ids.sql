...
WHERE project_id = '2a40c520-575d-46bc-9264-b43f56d7a044';

-- Project 2: 750 EDU project
UPDATE projects 
SET on_chain_project_id = '0x78f62f00e7e999c39bf91f5b5da527122c0e4a37c42e229b06a1ddffdf1ed5ba'
WHERE project_id = '27061523-ea39-4f93-a0eb-691fed374427';

-- Project 3: 1000 EDU project with the same ID as project 1 but different reward
UPDATE projects 
SET on_chain_project_id = '0x11e5f03e3edac1db13fa20db0a9ce4ea1c9d67d4741dad4d79e56f7455c16e62'
WHERE project_id = '2a40c520-575d-46bc-9264-b43f56d7a044' AND CAST(prize_amount AS integer) = 1000;

-- Log the updated rows to verify changes
SELECT project_id, project_name, prize_amount, on_chain_project_id 
FROM projects 
